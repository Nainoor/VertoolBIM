...
# Copyright (C) 2020, 2021 Nainoor Patel, 2022 Yassine Oualid <yassine@sigmadimensions.com>
#
...
class VertoolBIM_DatePicker(bpy.types.Operator):
...
class VertoolBIM_DatePickerSetDate(bpy.types.Operator):
    bl_label = "Set Date"
...
class VertoolBIM_RedrawDatePicker(bpy.types.Operator):
