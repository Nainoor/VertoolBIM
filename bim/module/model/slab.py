...
def calculate_quantities(usecase_path, ifc_file, settings):
    ...
    if not parametric or "Engine" not in parametric or parametric["Engine"] != "VertoolBIM.DumbLayer3":
        return
...
class DumbSlabGenerator:
    ...
    def create_slab(self):
        ...
        ifcopenshell.api.run("pset.edit_pset", self.file, pset=pset, properties={"Engine": "VertoolBIM.DumbLayer3"})
        obj.select_set(True)
        return obj
