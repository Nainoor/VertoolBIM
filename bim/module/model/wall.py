...
class DumbWallGenerator:
    ...
    def create_wall(self):
        ...
        ifcopenshell.api.run("pset.edit_pset", self.file, pset=pset, properties={"Engine": "VertoolBIM.DumbLayer2"})
        obj.select_set(True)
        return obj
...
def calculate_quantities(usecase_path, ifc_file, settings):
    ...
    if not parametric or "Engine" not in parametric or parametric["Engine"] != "VertoolBIM.DumbLayer2":
        return
